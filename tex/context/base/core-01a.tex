...
\def\dodoplaatsformule#1[#2]#3$$#4$$%
  {\begingroup
   ...
   \if!!donea % no number
     ...
     \definecomplexorsimpleempty\formulenummer
     \def\subformulenummer{\formulenummer}%
     \dostartformula#4\dostopformula
   \else
     \doifelse{#1}{\v!ja}
     ...
     \def\complexformulenummer%
       {\gdef\doeqno{}%
        ...
        \doformulenummer}%
     \definecomplexorsimple\formulenummer
     ...
     \doifelse{\@@fmplaats}{\v!links}
       {\dostartformula#4\doleqno\dostopformula}
       {\dostartformula#4\doeqno\dostopformula}%
   \fi
   \par
   \ignorespaces
   \endgroup}
...
%   {\dodofixdlijstelementEFG{\localframed
%      [\??li#1][\c!diepte=\!!zeropoint,\c!kleur=]}{#1}}
% 
...
%      {\def\\={ }% or better \relax ?
%       \setbox0=\hbox
%         {#1{\showcontrastlocation{\??ia}{#7}
%           {\dostartattributes{\??li#2}\c!letter\c!kleur{}%
%            \ignorespaces\dontconvertfont#5%
%            \dostopattributes}}}%
      ...
      \setbox0=\hbox
        {#2{\showcontrastlocation{\??ia}{#8}
          {\dostartattributes{\??li#3}\c!letter\c!kleur{}%
           ...
           \begstrut
           \getvalue{\??li#3\c!tekstcommando}{#6}% tekstcommando nieuw 
           \endstrut % struts new
           \dostopattributes}}}%
...
% \setbuffer[name]#2\endbuffer : saves to file #2.tmp
...
\stelopsommingenin  % undocumented
  [\c!niveaus=6,
   ...
   \c!na=\blanko,
   \c!afsluiter=.,
   \c!plaatsafsluiter=\v!ja, % kan gewoon check zijn op afsluiter
   \c!binnen=,
   \c!n=2,
   \c!items=4,
   \c!symbool=\itemlevel]
