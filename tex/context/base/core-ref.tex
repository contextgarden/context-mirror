...
\def\handleexecreference#1{\executecommand     {\currentdatareference}}
\def\handlepagereference#1{\gotorealpage   {}{}{\currentdatareference}}
\def\handlelistreference#1{\gotodestination{}{}{\currentdatareference}{}}

%D We first define a whole lot of viewer specific commands. The
%D references as seen by the user, like \type {CloseDocument}
...
%   {\ConvertConstantAfter\doifelse{#2}{\v!geen}
%      {\!!doneafalse}
%      {\!!doneatrue}%
%    \doifreferencefoundelse{#3}
%      {\setbox0=\if!!donea\hbox\else\hphantom\fi
