...
\startmessages  french  library: linguals
  title: language
      1: les motifs -- pour -- sont charg̩s (n=--,e=--,m=--)
      2: pas de motifs -- pour -- (n=--,e=--,m=--) (--,--)
      3: hyphenations -- pour -- charg̩s (n=--,e=--,m=--)
      4: pas d'hyphenations -- pour -- (n=--,e=--,m=--)
      5: les motifs pour -- ne sont pas charg̩s
      6: langue -- non d̩finie
      7: les options sp̩cifiques de langue [--] introduisent un -- saut
      8: les options sp̩cifiques de langue [--] sont ajout̩s en douceur
