...
% \expanded{\defineXMLentity[\mmllbrace]}{\getXMLentity{lbrace}}
% \expanded{\defineXMLentity[\mmlrbrace]}{\getXMLentity{rbrace}}

\expanded{\defineXMLentity[\iftrue \string{\else}\fi]}{\getXMLentity{lbrace}}
\expanded{\defineXMLentity[\iffalse{\else\string}\fi]}{\getXMLentity{rbrace}}
