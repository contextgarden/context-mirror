return {
 ...
 ["exceptions"]={
  ...
  ["data"]="cu-rie cu-ries gei-sha gei-shes goua-che goua-ches hip-py hip-pies hob-by hob-bies jeep jeeps joule joules klee-nex klee-nexs lar-ghet-ti lar-ghet-to lied lieder nos-al-tres ro-yal-ties ro-yal-ty vos-al-tres whis-ky whis-kies",
  ["length"]=225,
  ["n"]=26,
 },
 ["metadata"]={
  ["mnemonic"]="ca",
  ["source"]="hyph-ca",
  ["texcomment"]="% This file has been converted for the hyph-utf8 project from cahyph.tex, whose\
